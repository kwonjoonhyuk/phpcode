...
<body>
    ...
    <?php } else if (isset($_SESSION['userid'])) { ?>
        ...
        <center>
            <form action="mypage_pw_change_server.php" method="post">
                ...
                <label>현재 비밀번호 : </label>
                <input type="password" placeholder="현재 비밀번호" name="mypage_change_pw">
                <br><br>

                <label>새 비밀번호 : </label>
                <input type="password" placeholder="새 비밀번호" name="mypage_new_pw">
                <br><br>

                <label>새 비밀번호 확인 : </label>
                <input type="password" placeholder="새 비밀번호 확인" name="mypage_new_pw_re">
                <br><br>
                ...
                <button  onclick="f_link(); return false;">돌아가기</button>
