...
<body>
    ...
    <div class="board_wrap">
        ...
        <div class="container">
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">말머리
        ...
        <div class="board_list_wrap">
            <div class="board_list">
                ...
                // 일반 글 검색되지 않은 글 가져오는 부분 
                $query = " SELECT * FROM board order by idx DESC LIMIT $page_start , $list ";
            ...
            <div id="page_num" style="text-align: center; margin-top:15px;">
                ...
                if ($page <= 1) {
                    ...
                    $pre = $page - 1; ?>
                    <a href="noticeboard.php?page=<?= $pre ?>" style="font-size:20px; text-decoration:none;"> ◀ 이전 &nbsp;&nbsp; </a>
                    <?php }
                for ($i = $block_start; $i <= $block_end; $i++) {
                    if ($page == $i) { ?>
                        <b style="font-size: 20px;">&nbsp; <?= $i ?> </b>
                    <?php } else { ?>
                        <a href="noticeboard.php?page=<?= $i ?>" style="font-size: 20px; text-decoration:none;">&nbsp; <?= $i ?> </a>
                    <?php }
                }
                ...
                if ($page >= $total_page) {
                    ...
                    $next = $page + 1; ?>
                    <a href="noticeboard.php?page=<?= $next ?>" style="font-size: 20px; text-decoration:none;"> &nbsp;&nbsp; 다음 ▶</a>

                <?php }
                if ($page >= $total_page) {
                    //빈 값 
                } else { ?>
                    <a href="noticeboard.php?page=<?= $total_page ?>" style="font-size: 20px; text-decoration:none;">&nbsp;&nbsp; 마지막</a>
                <?php } ?>
