    ...
    <div class="board_wrap">
        ...
        <div class="board_list_wrap">
            <div class="board_list">
                ...
                $query = " SELECT * FROM board WHERE $category LIKE '%$search%' order by idx DESC LIMIT $page_start , $list ";
            ...
            <div id="page_num" style="text-align: center; margin-top:15px;">
                ...
                if ($page <= 1) {
                    ...
                    $pre = $page - 1; ?>
                    <a href="noticeboard_search_page.php?category=<?= $category ?>&search=<?= $search ?>&page=<?= $pre ?>" style="font-size:20px; text-decoration:none;"> ◀ 이전 &nbsp;&nbsp; </a>
                    <?php }
                for ($i = $block_start; $i <= $block_end; $i++) {
                    if ($page == $i) { ?>
                        <b style="font-size: 20px;">&nbsp; <?= $i ?> </b>
                    <?php } else { ?>
                        <a href="noticeboard_search_page.php?category=<?= $category ?>&search=<?= $search ?>&page=<?= $i ?>" style="font-size: 20px; text-decoration:none;">&nbsp; <?= $i ?> </a>
                    <?php }
                }
                ...
                if ($page >= $total_page) {
                    ...
                    $next = $page + 1; ?>
                    <a href="noticeboard_search_page.php?category=<?= $category ?>&search=<?= $search ?>&page=<?= $next ?>" style="font-size: 20px; text-decoration:none;"> &nbsp;&nbsp; 다음 ▶</a>

                <?php }
                if ($page >= $total_page) {
                    //빈 값 
                } else { ?>
                    <a href="noticeboard_search_page.php?category=<?= $category ?>&search=<?= $search ?>&page=<?= $total_page ?>" style="font-size: 20px; text-decoration:none;">&nbsp;&nbsp; 마지막</a>
                <?php } ?>
